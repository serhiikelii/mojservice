...
-- Initial migration: Device categories, models, services, prices, discounts
...
-- Admin write access (will be configured later with specific role)
-- For now, we'll use service_role for admin operations
